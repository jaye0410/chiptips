		...
		<section class="content" id="gc_bonus_list">
			...
			<article class="gc">
				...
				<li>カミーノ：「基礎訓練」<br>
						...
						ユニットは敵にダメージを与えるたび、または、HPを回復するたび、<span chass="strong">士気</span>のスタックを得る。弱体化効果あるいはダメージを受けると、ユニットは士気のスタックを失う。
						ユニットは敵を倒すたび、戦闘不能になった敵の<span chass="strong">士気</span>のスタックを全て得る。<br>
						<span chass="strong">士気</span>のスタックが10以上あるユニットは、ターンを開始するたび、1ターンのアドバンテージを得る。
						<span chass="strong">士気</span>のスタックが15以上あるユニットはターン終了時に、1ターンのプロテクション上昇 (50%) を得る。<br>
						<span chass="strong">士気</span>：クリティカルダメージ、防御力、最大HP、有効性、抵抗力がスタックごとに3%上昇する。
					</li>
					<li>キャッシーク：「正当な報復」<br>
				...
				<ul>
					...
					<li>反乱軍ファイター：「ピンポイント」<br>
						反乱軍ファイターが特殊スキルを使用するたび、<span chass="strong">ピンポイント</span>状態の敵がいない場合、
						ターゲットに2ターンの<span chass="strong">ピンポイント</span>を発生させる (解除、阻止、耐性発揮不可)。
						<span chass="strong">ピンポイント</span>状態の敵は、反乱軍ファイターからダメージを受けるたび、HPが2%減少する。
						反乱軍ファイターは<span chass="strong">ピンポイント</span>状態の敵に通常スキルを使用するたび、時間経過回復のスタックを獲得し、
						<span chass="strong">ピンポイント</span>状態の敵に特殊スキルを使用するたび、時間経過回復が発生している反乱軍ファイターの味方全体をアシストに呼ぶ。
						<br>
						反乱軍ファイターは、<span chass="strong">ピンポイント</span>状態の敵を倒すたびボーナスターンを得て、
						反乱軍ファイター全体は2ターンの間アドバンテージ、クリティカルダメージ上昇、スピード上昇を得る。
						時間経過回復のスタックが10以上ある反乱軍ファイターは、HPとプロテクションが50%の状態で復活する。
						ユニットの<span chass="strong">ピンポイント</span>の効果が切れるたび、そのユニットのHPが100%回復する。<br>
						<span chass="strong">ピンポイント</span>：敵の攻撃にボーナス効果が発生する。
					</li>
				</ul>
